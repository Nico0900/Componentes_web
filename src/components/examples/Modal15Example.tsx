    ...
    <div className="flex justify-center items-center p-6 relative min-h-[400px]">
      {isOpen && (
        <div className="absolute inset-0 z-50 flex items-center justify-center p-4 animate-fadeIn">
          ...
          <div className="relative bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md min-w-[400px] border border-slate-700 overflow-hidden animate-slideUp">
    ...
    <div className="flex justify-center items-center p-6 relative min-h-[400px]">
      {isOpen && (
        <div className="absolute inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md min-w-[400px] border border-slate-700 p-6">
