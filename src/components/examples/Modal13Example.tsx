    ...
    <>
      ...
      <div className="flex justify-center items-center w-full h-full p-8">
        <button
          ...
          className="w-full max-w-2xl bg-slate-800 rounded-2xl overflow-hidden shadow-2xl hover:shadow-fuchsia-500/20 transition-all duration-300 hover:scale-[1.02] cursor-pointer"
        >
          <div className="p-6 border-b border-slate-700 bg-slate-800/50">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-linear-to-br from-fuchsia-500 to-purple-600 rounded-xl flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
              </div>
              <div className="flex-1">
                <h3 className="text-lg font-bold text-slate-100">Search Modal</h3>
                <p className="text-xs text-slate-400">Quick search anything</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="space-y-2">
              {[
                { title: 'React Components', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
                { title: 'Modal Patterns', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' }
              ].map((item, idx) => (
      ...
      {isOpen && (
        <div className="fixed inset-0 z-9999 bg-slate-950/80 backdrop-blur-sm animate-fadeIn">
          <div className="flex items-start justify-center p-4 pt-20">
            <div className="w-full max-w-2xl min-w-[600px] bg-slate-800 rounded-2xl shadow-2xl border border-slate-700 animate-slideUp">
    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 bg-slate-950/80">
          <div className="flex items-start justify-center p-4 pt-20">
            <div className="w-full max-w-2xl min-w-[600px] bg-slate-800 rounded-2xl shadow-2xl border border-slate-700">
              <div className="p-6 border-b border-slate-700">
                <div className="flex items-center gap-3">
                  <svg className="w-6 h-6 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
